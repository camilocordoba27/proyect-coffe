                ...
                <div className="container min-h-[550px] flex justify-center items-center py-12 sm:py-0">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                            ...
                            <p className='text-sm -text-gray-500 tracinkg-wide leading-5'>
                                Discover perfection in every cup with our premium coffee, a careful selection of the best single-origin coffee beans, roasted to perfection to give you unparalleled flavor and a truly exceptional experience.</p>
